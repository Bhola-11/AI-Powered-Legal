...
def create_statutes_builder():
    os.makedirs("scripts/builders", exist_ok=True)
    with open("scripts/builders/build_statutes.py", "w", encoding="utf-8") as f:
        f.write('''# builder for statutory codifications
import os
...
create_statutes_builder()
print("Created scripts/builders/build_statutes.py")
